...
namespace CRM_UI
{
    public partial class Catalog<T> : Form where T:class
    {
        ...
        {
            InitializeComponent();
            this.db = db;  //transfer context database
            this.set = set;//transfer collection
            set.Load(); //unload from database
        ...
        {
            var id = dataGridView.SelectedRows[0].Cells[0].Value;//identyfy write
